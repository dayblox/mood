							...
							<div class="hidden sm:mb-8 sm:flex sm:justify-center">
								<div class="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
									<span class="text-gray-600">
										Pooring out features and projects right now!
									</span>
								</div>
							</div>
							<div>
								<h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
									The Full Stack engineer you need
								</h1>
								...
								<div class="mt-8 flex gap-x-4 sm:justify-center">
									...
									>
										Hire
										<span class="text-indigo-200 pl-1" aria-hidden="true">
											&rarr;
										</span>
									</a>
									<a
									...
									>
										See Projects
										<span class="text-gray-400 pl-1" aria-hidden="true">
											&rarr;
										</span>
									</a>
								</div>
